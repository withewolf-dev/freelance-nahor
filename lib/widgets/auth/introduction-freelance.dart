...
class IntroductionFreelance extends StatefulWidget {
  final PageRouteInfo route;
  IntroductionFreelance(
  ...
  @override
  _IntroductionFreelanceState createState() => _IntroductionFreelanceState();
}

class _IntroductionFreelanceState extends State<IntroductionFreelance> {
